package se.advent.linda.fourteenth;
...
public class Day14 {
    ...
    String make_raw_data(String test){
        File raw_data = new File("C:\\Users\\loric\\Documents\\Advent of code 2024\\adventoc\\src\\main\\java\\se\\advent\\linda\\fourteenth\\input" + test + ".txt");
        String line = "";
