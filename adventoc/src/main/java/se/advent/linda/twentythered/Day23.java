package se.advent.linda.twentythered;
...
public class Day23 {
     String make_raw_data(String test){
        File raw_data = new File("C:\\Users\\loric\\Documents\\Advent of code 2024\\adventoc\\src\\main\\java\\se\\advent\\linda\\twentythered\\input" + test + ".txt");
        String line = "";
